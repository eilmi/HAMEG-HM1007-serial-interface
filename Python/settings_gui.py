...
class SettingsWindow(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.folderlabel = tk.Label(self.frame, textvariable=self.parent.folderdir, width=30)
        ...
        self.saverawlogcb = tk.Checkbutton(self.frame,text="raw log", variable=self.parent.saverawlog)
        self.saverawlogcb.grid(column=0, row=9)
        self.savecsvcb = tk.Checkbutton(self.frame,text="csv", variable=self.parent.savecsv)
        self.savecsvcb.grid(column=1, row=9)
        self.saveimgcb = tk.Checkbutton(self.frame,text="png", variable=self.parent.saveimg)
        self.saveimgcb.grid(column=2, row=9)

        self.savebutton = tk.Button(self.frame,text="Save", command=self.parent.savedata)
